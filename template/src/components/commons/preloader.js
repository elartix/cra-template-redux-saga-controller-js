...
export const Preloader = withLoader(({ className, ...attr }) => {
  return <div className={cn('app-preloader', className)} { ...attr }>
    <div className="move-progress-dot">
      <div className="mp-dot-1" />
      <div className="mp-dot-2" />
      <div className="mp-dot-3" />
      <div className="mp-dot-4" />
    </div>
  </div>;
});
Preloader.propTypes = {
...
export const BoxPreloader = memo(function BoxPreloader (props) {
  return <Preloader className="box-preloader" {...props} />;
});
